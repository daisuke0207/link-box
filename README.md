...
# 概要
プロジェクトを勉強していると、少しずつタブが散らかっていくことがあるため、ページを保存して整理するアプリを作成しました。
よく開くページ、再読したいというページリンクを登録していつでも開けるようにする。また、リンクを用途別にグループ化して登録できるため目的のページをすぐ見つかります。たくさん保存しても検索機能で対象を絞ります。
